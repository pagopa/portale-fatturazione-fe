...
const MainInserimentoModuloCommessa = ({
  ...
  const sortedRegioni: Regioni[] = activeCommessa?.valoriRegione
    ? [...activeCommessa.valoriRegione].sort((a, b) => {
        ...
        <div>
          ...
          <Box>
            ...
            <div  className="bg-white mt-3 pt-3 ">
              ...
              <div>
                {sortedRegioni.map((element,index) => (
                  <div
