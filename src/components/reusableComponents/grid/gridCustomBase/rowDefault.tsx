...
const DefaultRow = ({element, sliced, apiGet, headerNames,nameParameterApi}) => {
  ...
  return (
    <TableRow 
      ...
      {apiGet && <TableCell key={`arrow-mod-commess-${element.id}`} align="center" onClick={()=>{apiGet(element);}}>
