...
const RowContestazioni = ({sliced,apiGet,element,headerNames}) => {
  ...
  return (
    <TableRow key={Math.random()}
      ...
      {apiGet &&  <TableCell align="center"><IconButton onClick={()=>{apiGet({ id: element.reportId });}} ><ArrowForwardIcon fontSize="small" sx={{ color: '#1976D2', cursor: 'pointer' }} /></IconButton></TableCell> }
    </TableRow>
  );
};
