...
const RowAsyncDoc = ({sliced,headerNames,element,apiGet}) => {
          ...
          if(value === "--" || typeof(value) === "boolean"){
            ...
            return (
              <TableCell
                key={i}
                align={headerNames[i]?.align}>
                {headerNames[i]?.gridAction(apiGet,"primary",sliced.stato !== "Elaborato" ? true : false,{idReport:element.reportId})}                
              </TableCell>
            );
          }else{
            return (
