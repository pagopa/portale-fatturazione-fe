...
interface GridCollapsibleDocEmessi{
    data:FattureObj[],
...
const CollapsibleTableStandard: React.FC<GridCollapsibleDocEmessi> = ({data, showedData, setShowedData, headerNames}) => {
...
export default CollapsibleTableStandard;
    ...
    return(
        ...
        <TableBody sx={{minHeight:"100px"}}>
            <TableRow  sx={{ '& > *': { borderBottom: 'unset' } }}>
                ...
                <TableCell align='left' sx={{color:'#0D6EFD',fontWeight: 'bold'}} >{row.ragionesociale}</TableCell>
