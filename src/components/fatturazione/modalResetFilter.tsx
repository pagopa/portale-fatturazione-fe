        ...
        Attenzione!
                        ...
                        <div className='mt-3'>
                            <Typography id="modal-modal-description" variant="body1">
                                {`Il mese selezionato nei filtri "${month[(filterNotExecuted.mese||0) -1]?.toLocaleUpperCase()}" non è in linea con il mese "${month[(filterInfo.mese||0) -1]?.toLocaleUpperCase()}" delle fatture visualizzate`}
                            </Typography>
                        </div>
                    </div>
