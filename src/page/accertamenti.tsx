...
const Accertamenti : React.FC<AccertamentiProps> = ({dispatchMainState}) =>{
    ...
    const columns: GridColDef[] = [
        ...
        {field: 'action', headerName: '',sortable: false,width:70,headerAlign: 'left',disableColumnMenu :true,renderCell: ((param:{id:any,row:Accertamento}) => ( <DownloadIcon sx={{marginLeft:'10px',color: '#1976D2', cursor: 'pointer'}} onClick={()=> downloadAccertamento(param.id,param.row.mese,param.row.anno,param.row.descrizione,param.row.contentType)}></DownloadIcon>)),}
    ];
