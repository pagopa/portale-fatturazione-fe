...
export const headersName: HeaderGridCustom[] = [
  { label: 'Ragione Sociale',align:'left',width:'300px', headerAction:false,keyValue:'ragioneSociale',typeColumn:"ragionesociale",makeAction:true,applyCss:true},
  ...
  { label: 'Stato',align:'center',width:'300px',headerAction:false,keyValue:'descrizioneStato',typeColumn:'chip',funToManipulateValue:getColorChipContestazioneStorico, keyToManipulateData:"stato"},
  { label: 'Categoria Doc.',align:'center',width:'200px',headerAction:false,keyValue:'categoriaDocumento',typeColumn:"string"},
