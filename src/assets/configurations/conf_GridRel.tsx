...
export const headerRelEnte: HeaderGridCustom[] = [
  { label: "Ragione Sociale", align: "center", width: "180px", keyValue: "ragioneSociale",typeColumn:"ragionesociale",makeAction:true, applyCss:true },
  ...
  { label: "Reg. Es. PDF", align: "center", width: "150px", keyValue: "firmata", typeColumn:"string" },
  { label: "ID Contratto", align: "center", width: "150px", keyValue: "idContratto" , typeColumn:"string"},
