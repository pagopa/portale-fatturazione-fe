export const headersName: {label:string,align:string,width:number|string,headerAction:boolean}[]= [
    { label: 'Esecuzione',align:'center',width:'160px', headerAction:true},
    ...
    { label: 'Processo',align:'center',width:'100px',headerAction:false}];