...
export const headerNamesTipologia: HeaderGridCustom[] = [
  ...
  {label:"Data aggiornamento", align:"center", width:"150px",keyValue:"dataInserimento", typeColumn:'data'},
  {label:"Tipologia contatto", align:"center", width:"150px",keyValue:"tipoContratto", typeColumn:'switch', switchValue:[{keySwitch:2, valueSwitch:"PAC"},{keySwitch:1, valueSwitch:"PAL"}]}
];