...
export const headersObjGridDocemessiSend : HeaderGridCustom[] = [
  ...
  { label: "Tipo Contratto", align: "center", width: "170px", keyValue: "tipoContratto", typeColumn: "string-tipocontratto" },
  ...
  { label: "Tipo Documento", align: "center", width: "200px", keyValue: "tipoDocumento", typeColumn: "string" },
