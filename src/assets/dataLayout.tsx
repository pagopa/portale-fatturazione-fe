import { CompanyLinkType, FooterLinksType, PreLoginFooterLinksType, ProductEntity } from "@pagopa/mui-italia";

export const pagoPALinkHeder = {
    label: 'PagoPA S.p.A.',
...
export const companyLegalInfo = (
  ...
  15376371009 - {`V.${import.meta.env.VITE_APP_VERSION}`}
    </>
);
...
export const arrayProducts:ProductEntity[] = [
    {
        id: '1',
        title:'SEND - Servizio Notifiche Digitali',
        productUrl:"",
