...
i18n.use(initReactI18next) // Passes i18n down to react-i18next
  .init({
    fallbackLng: 'it', // I changed 'ita' → 'it' for standard language code
    resources: {
      it: {
        translation: {
          errori: {
            ...
            "404_RIGHE_ID": "Il report di dettaglio notifiche Regolare Esecuzione non è disponibile. Contattare l'assistenza",
            "404_RIGHE_ID_EMESSE":"Il report di dettaglio notifiche Documenti Emessi non è disponibile. Contattare l'assistenza",
            "404_RIGHE_ID_SOSPESE":"Il report di dettaglio notifiche Documenti Sospesi non è disponibile. Contattare l'assistenza",
